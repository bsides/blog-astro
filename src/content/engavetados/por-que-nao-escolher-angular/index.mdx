...
description: 'Em uma conversa com uma recrutadora muito bacana eu acabei recusando uma vaga devido ao projeto trabalhar com AngularJS e quererem migrar para Angular 8+ em breve.'
tags: ['angular', 'frameworks', 'react', 'framework']
excerpt: 'Em uma conversa com uma recrutadora muito bacana eu acabei recusando uma vaga devido ao projeto trabalhar com AngularJS e quererem migrar para Angular 8+ em breve.'
pubDate: '2019-08-21T10:36:53.875Z'
---
...
_controller_ pra regular suas variáveis e escopo, tem que ter um _serviço_ caso
precise acessar uma API, tem que ter um _pipe_ caso precise transformar um dado,
_rotas_ caso precise delas, _módulos_ e _injeção_ para conectar tudo isso...
...
[Axios](https://github.com/axios/axios), que já foi _battle tested_, evitando
