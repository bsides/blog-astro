...
description: 'Saiu o resultado do State of JavaScript, uma pesquisa que acontece anualmente sobre usos e satisfação dos usuários da linguagem.'
tags: ['javascript']
excerpt: 'Saiu o resultado do State of JavaScript, uma pesquisa que acontece anualmente sobre usos e satisfação dos usuários da linguagem.'
pubDate: '2018-12-07T18:30:53.875Z'
hero: 'stateofjs.png'
---
